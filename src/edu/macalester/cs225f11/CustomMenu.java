...
public class CustomMenu {
	...
	public CustomMenu(Context context, OnMenuItemSelectedListener listener, LayoutInflater lo, QuickAction quickAction) {
	...
	public synchronized void show(View v) {
		...
		View mView= mLayoutInflater.inflate(R.layout.grand_menu, null);
        ...
        for (int i=0; i < mRows; i++) {
    		...
    		for (int j=0; j< divisor; j++) {
    			...
    			View itemLayout = mLayoutInflater.inflate(R.layout.grand_menu_item, null);
